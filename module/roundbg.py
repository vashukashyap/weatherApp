...
class RoundedBox(tk.Canvas):
    ...
    def __init__(self, master=None, text:str="", radius=25, btnforeground="#000000", btnbackground="#ffffff", clicked=None, btnborder=None,btnwidth=2, *args, **kwargs):
        super(RoundedBox, self).__init__(master, *args, **kwargs)
        self.config(bg=self.master["bg"])
        self.btnbackground = btnbackground
        self.clicked = clicked
        self.btnborder = btnborder
        self.btnwidth = btnwidth
        self.radius = radius        
        
        self.rect = self.round_rectangle(0, 0, 0, 0, tags="button", radius=radius, fill=btnbackground , outline=btnborder, width=btnwidth)
